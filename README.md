![docker image](https://github.com/ondracka/nomad-distro-template/actions/workflows/docker-publish.yml/badge.svg)


# ondracka's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of ondracka.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/ondracka/nomad-distro-template.git
    ...
    ```sh
    curl-L -o nomad-distro-template.zip "https://github.com/ondracka/nomad-distro-template/archive/main.zip"
...
your `docker-compose.yaml` with `ghcr.io/ondracka/nomad-distro-template:main` for the services
...
```sh
docker pull ghcr.io/ondracka/nomad-distro-template/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/ondracka/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/ondracka/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/ondracka/nomad-distro-template/manifests/main": unauthorized`
